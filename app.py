...
Features:
  ...
  - Chat interface with streaming feel
  - Agent status & reflection indicators
...
def chat_handler(message: str, history: list) -> tuple:
    ...
    # Update the assistant response in history
    history[-1][1] = answer
        ...
        with gr.Row():
            ...
            with gr.Column(scale=2, min_width=500):
                ...
                <div class="footer">
                    ...
                    Built by Raktim Banerjee • Powered by ChromaDB + BGE Embeddings
                </div>
                """)
